defmodule Singularity.Workflow.WorkflowRun do
  @moduledoc """
  ...
  ## Usage
      ...
      |> Singularity.Workflow.WorkflowRun.changeset(%{
      ...
      # Query active runs
      from(r in Singularity.Workflow.WorkflowRun, where: r.status == "started")
      |> Repo.all()
  """
  ...
  schema "workflow_runs" do
    ...
    has_many(:step_states, Singularity.Workflow.StepState, foreign_key: :run_id)
    has_many(:step_tasks, Singularity.Workflow.StepTask, foreign_key: :run_id)
  end
  ...
  ## Examples
      ...
      iex> changeset = Singularity.Workflow.WorkflowRun.changeset(%Singularity.Workflow.WorkflowRun{}, %{
  ...
  ## Examples
      ...
      iex> run = Repo.get!(Singularity.Workflow.WorkflowRun, run_id)
      iex> changeset = Singularity.Workflow.WorkflowRun.mark_completed(run, %{
      ...>   "result" => "success",
      ...>   "processed_items" => 42,
      ...>   "duration_ms" => 1234
      ...> })
  ...
  ## Examples
      ...
      iex> run = Repo.get!(Singularity.Workflow.WorkflowRun, run_id)
      iex> changeset = Singularity.Workflow.WorkflowRun.mark_failed(run, "Step :payment failed: Invalid card number")
      iex> changeset.changes.status
      "failed"
