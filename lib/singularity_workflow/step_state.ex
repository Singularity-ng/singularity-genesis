defmodule Singularity.Workflow.StepState do
  @moduledoc """
  ...
  ## Usage
      ...
      for step <- workflow_steps do
        ...
        |> Singularity.Workflow.StepState.changeset(%{
          run_id: run.id,
  ...
  schema "workflow_step_states" do
    ...
    has_many(:tasks, Singularity.Workflow.StepTask, foreign_key: :step_slug, references: :step_slug)
  end
  ...
  ## Examples
      ...
      iex> changeset = Singularity.Workflow.StepState.changeset(%Singularity.Workflow.StepState{}, %{
  ...
  ## Examples
      ...
      iex> step_state = Repo.get_by!(Singularity.Workflow.StepState, run_id: run_id, step_slug: "fetch")
      iex> changeset = Singularity.Workflow.StepState.mark_started(step_state, 1)
      iex> changeset.changes
      %{status: "started", initial_tasks: 1, remaining_tasks: 1, started_at: ~U[...]}

      # Map step with multiple tasks
      iex> changeset = Singularity.Workflow.StepState.mark_started(step_state, 50)
