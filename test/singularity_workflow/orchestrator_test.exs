defmodule Singularity.Workflow.OrchestratorTest do
  use ExUnit.Case, async: true

  alias Singularity.Workflow.Orchestrator
  ...
  describe "execute_goal/5" do
    test "executes goal successfully" do
      ...
      # Mock the Executor
      Mox.stub(Singularity.Workflow.Executor.Mock, :execute, fn _workflow, _context, _repo ->
  ...
  describe "get_execution_stats/2" do
    test "returns execution statistics" do
      {:ok, stats} = Orchestrator.get_execution_stats("test_workflow", Singularity.Workflow.Repo)
