...
defmodule Singularity.Workflow.ExecutorTest do
  ...
  setup do
    ...
    Ecto.Adapters.SQL.Sandbox.mode(Singularity.Workflow.Repo, {:shared, self()})
  ...
  describe "execute_dynamic/5 - Dynamic workflow execution" do
    test "executes workflow loaded from database" do
      ...
      {:ok, _workflow} = Singularity.Workflow.FlowBuilder.create_flow("test_dynamic_simple", Repo)
  ...
  describe "Concurrency and idempotency" do
    ...
    test "workflow can be safely retried after failure" do
      ...
      Repo.delete_all(Singularity.Workflow.StepDependency)
      Repo.delete_all(Singularity.Workflow.StepTask)
