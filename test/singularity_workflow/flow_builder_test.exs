defmodule Singularity.Workflow.FlowBuilderTest do
  ...
  setup do
    ...
    {:ok, _} = Singularity.Workflow.TestWorkflowPrefix.cleanup_by_prefix("test_", Repo)
    ...
    prefix = Singularity.Workflow.TestWorkflowPrefix.start()
  ...
  describe "list_flows/1 - Listing workflows" do
    ...
    test "orders workflows by created_at DESC" do
      ...
      Singularity.Workflow.TestClock.advance(1000)
